<template>
  <div>
    ...
    <!-- 添加角色对话框 -->
    <el-dialog title="添加角色" :visible.sync="AddRoleDialogVisible" width="40%" @close="addRoleDialogClosed(true)">
    ...
    <!-- 编辑角色对话框 -->
    <el-dialog title="编辑角色" :visible.sync="editRoleDialogVisible" width="40%" @close="addRoleDialogClosed(false)">
...
export default {
  ...
  methods: {
    ...
    // 添加角色对话框的关闭
    addRoleDialogClosed(bool) {
      if (bool) return this.$refs.addRoleFormRef.resetFields()
